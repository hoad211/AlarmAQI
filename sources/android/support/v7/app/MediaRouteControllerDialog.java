...
public class MediaRouteControllerDialog extends AlertDialog {
    ...
    /* access modifiers changed from: 0000 */
    public void animateGroupListItemsInternal(Map<RouteInfo, Rect> previousRouteBoundMap, Map<RouteInfo, BitmapDrawable> previousRouteBitmapMap) {
        ...
        if (this.mGroupMemberRoutesAdded != null && this.mGroupMemberRoutesRemoved != null) {
            ...
            AnonymousClass9 r0 = new AnimationListener() {
            ...
            for (Entry<RouteInfo, BitmapDrawable> item : previousRouteBitmapMap.entrySet()) {
                RouteInfo route2 = (RouteInfo) item.getKey();
                BitmapDrawable bitmap = (BitmapDrawable) item.getValue();
                Rect bounds = (Rect) previousRouteBoundMap.get(route2);
                if (this.mGroupMemberRoutesRemoved.contains(route2)) {
                    OverlayObject overlayObject = new OverlayObject(bitmap, bounds);
                    object = overlayObject.setAlphaAnimation(1.0f, 0.0f).setDuration((long) this.mGroupListFadeOutDurationMs).setInterpolator(this.mInterpolator);
                } else {
                    int deltaY = groupSizeDelta * this.mVolumeGroupListItemHeight;
                    OverlayObject overlayObject2 = new OverlayObject(bitmap, bounds);
                    OverlayObject interpolator = overlayObject2.setTranslateYAnimation(deltaY).setDuration((long) this.mGroupListAnimationDurationMs).setInterpolator(this.mInterpolator);
                    final RouteInfo routeInfo = route2;
                    AnonymousClass10 r02 = new OnAnimationEndListener() {
                    ...
                    object = interpolator.setAnimationEndListener(r02);
    ...
    /* access modifiers changed from: 0000 */
    public boolean isVolumeControlAvailable(RouteInfo route) {
