...
final class MediaRouterJellybean {
    ...
    static boolean isBluetoothA2dpOn(Object routerObj) {
        ...
        try {
            ...
            Method method = globalRouterObj.getClass().getDeclaredMethod("isBluetoothA2dpOn", new Class[0]);
            method.setAccessible(true);
            return ((Boolean) method.invoke(globalRouterObj, new Object[0])).booleanValue();
