        ...
        if (this.mRunning) {
            ...
            for (ResolveInfo resolveInfo : this.mPackageManager.queryIntentServices(new Intent("android.media.MediaRouteProviderService"), 0)) {
                ...
                if (serviceInfo != null) {
                    ...
                    if (sourceIndex < 0) {
                        ...
                        RegisteredMediaRouteProvider provider2 = (RegisteredMediaRouteProvider) this.mProviders.get(sourceIndex);
                        provider2.start();
            ...
            if (targetIndex < this.mProviders.size()) {
                for (int i = this.mProviders.size() - 1; i >= targetIndex; i--) {
                    RegisteredMediaRouteProvider provider3 = (RegisteredMediaRouteProvider) this.mProviders.get(i);
