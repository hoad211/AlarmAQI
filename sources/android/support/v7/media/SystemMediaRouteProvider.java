...
import android.support.v7.media.MediaRouterApi24.RouteInfo;
...
abstract class SystemMediaRouteProvider extends MediaRouteProvider {
    ...
    private static class Api24Impl extends JellybeanMr2Impl {
        ...
        public void onBuildSystemRouteDescriptor(SystemRouteRecord record, Builder builder) {
            ...
            builder.setDeviceType(RouteInfo.getDeviceType(record.mRouteObj));
        }
    }
    ...
    static class LegacyImpl extends SystemMediaRouteProvider {
        ...
        public void publishRoutes() {
            ...
            setDescriptor(new MediaRouteProviderDescriptor.Builder().addRoute(new Builder(SystemMediaRouteProvider.DEFAULT_ROUTE_ID, r.getString(R.string.mr_system_route_name)).addControlFilters(CONTROL_FILTERS).setPlaybackStream(3).setPlaybackType(0).setVolumeHandling(1).setVolumeMax(maxVolume).setVolume(this.mLastReportedVolume).build()).build());
        }
