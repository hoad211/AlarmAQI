...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public int getBaseline() {
        ...
        if (childBaseline != -1) {
            ...
            if (this.mOrientation == 1) {
                int majorGravity = this.mGravity & alarmaqi.android.R.styleable.AppCompatTheme_spinnerStyle;
                if (majorGravity != 48) {
                    switch (majorGravity) {
                        case 16:
                            childTop += ((((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom()) - this.mTotalLength) / 2;
                            break;
                        case alarmaqi.android.R.styleable.AppCompatTheme_panelMenuListWidth /*80*/:
            ...
            if (child == null) {
                ...
                if (baselineAligned) {
                    ...
                    if (childBaseline != -1) {
                        ...
                        int index = (((i2 & alarmaqi.android.R.styleable.AppCompatTheme_spinnerStyle) >> 4) & -2) >> 1;
                ...
                if (!(child3 == null || child3.getVisibility() == 8)) {
                    ...
                    if (baselineAligned) {
                        ...
                        if (childBaseline2 != -1) {
                            ...
                            int index2 = (((i & alarmaqi.android.R.styleable.AppCompatTheme_spinnerStyle) >> 4) & -2) >> 1;
    ...
    public void layoutVertical(int left, int top, int right, int bottom) {
        ...
        switch (this.mGravity & alarmaqi.android.R.styleable.AppCompatTheme_spinnerStyle) {
            case 16:
    ...
    public void layoutHorizontal(int left, int top, int right, int bottom) {
        ...
        int minorGravity = this.mGravity & alarmaqi.android.R.styleable.AppCompatTheme_spinnerStyle;
        boolean baselineAligned = this.mBaselineAligned;
        int[] maxAscent = this.mMaxAscent;
        int[] maxDescent = this.mMaxDescent;
        ...
        while (i < count) {
            ...
            if (child == null) {
                ...
                switch (gravity & alarmaqi.android.R.styleable.AppCompatTheme_spinnerStyle) {
                    case 16:
                        childTop = ((((childSpace - childHeight) / 2) + paddingTop) + lp.topMargin) - lp.bottomMargin;
                        break;
                    case alarmaqi.android.R.styleable.AppCompatTheme_spinnerDropDownItemStyle /*48*/:
    ...
    public void setGravity(int gravity) {
        if (this.mGravity != gravity) {
            ...
            if ((gravity & alarmaqi.android.R.styleable.AppCompatTheme_spinnerStyle) == 0) {
                gravity |= 48;
            }
    ...
    public void setVerticalGravity(int verticalGravity) {
        int gravity = verticalGravity & alarmaqi.android.R.styleable.AppCompatTheme_spinnerStyle;
        if ((this.mGravity & alarmaqi.android.R.styleable.AppCompatTheme_spinnerStyle) != gravity) {
