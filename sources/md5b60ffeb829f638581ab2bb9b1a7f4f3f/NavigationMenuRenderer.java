...
public class NavigationMenuRenderer extends ViewRenderer implements IGCUserPeer {
    ...
    public NavigationMenuRenderer(Context context, AttributeSet attributeSet, int i) {
    ...
    public NavigationMenuRenderer(Context context, AttributeSet attributeSet) {
    ...
    public NavigationMenuRenderer(Context context) {
        super(context);
        if (getClass() == NavigationMenuRenderer.class) {
