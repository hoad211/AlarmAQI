    ...
    public static void LoadApplication(Context context, ApplicationInfo applicationInfo, String[] strArr) {
        synchronized (lock) {
            ...
            if (!initialized) {
                ...
                Runtime.init(str, strArr2, getNativeLibraryPath(applicationInfo), new String[]{absolutePath, absolutePath2, nativeLibraryPath}, classLoader, new String[]{absolutePath3, absolutePath4}, MonoPackageManager_Resources.Assemblies, context.getPackageName());
