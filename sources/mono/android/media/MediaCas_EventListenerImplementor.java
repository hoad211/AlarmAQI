...
public class MediaCas_EventListenerImplementor implements IGCUserPeer, EventListener {
    ...
    static {
        Runtime.register("Android.Media.MediaCas+IEventListenerImplementor, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", MediaCas_EventListenerImplementor.class, __md_methods);
    }

    public MediaCas_EventListenerImplementor() {
        if (getClass() == MediaCas_EventListenerImplementor.class) {
            TypeManager.Activate("Android.Media.MediaCas+IEventListenerImplementor, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "", this, new Object[0]);
        }
    }
