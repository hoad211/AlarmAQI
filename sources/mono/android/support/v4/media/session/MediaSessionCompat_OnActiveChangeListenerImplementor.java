...
public class MediaSessionCompat_OnActiveChangeListenerImplementor implements IGCUserPeer, OnActiveChangeListener {
    ...
    static {
        Runtime.register("Android.Support.V4.Media.Session.MediaSessionCompat+IOnActiveChangeListenerImplementor, Xamarin.Android.Support.Media.Compat, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MediaSessionCompat_OnActiveChangeListenerImplementor.class, __md_methods);
    }
    ...
    public MediaSessionCompat_OnActiveChangeListenerImplementor() {
        if (getClass() == MediaSessionCompat_OnActiveChangeListenerImplementor.class) {
            TypeManager.Activate("Android.Support.V4.Media.Session.MediaSessionCompat+IOnActiveChangeListenerImplementor, Xamarin.Android.Support.Media.Compat, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new Object[0]);
        }
    }
