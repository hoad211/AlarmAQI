...
public class MenuItemCompat_OnActionExpandListenerImplementor implements IGCUserPeer, OnActionExpandListener {
    ...
    static {
        Runtime.register("Android.Support.V4.View.MenuItemCompat+IOnActionExpandListenerImplementor, Xamarin.Android.Support.Compat, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MenuItemCompat_OnActionExpandListenerImplementor.class, __md_methods);
    }
    ...
    public MenuItemCompat_OnActionExpandListenerImplementor() {
        if (getClass() == MenuItemCompat_OnActionExpandListenerImplementor.class) {
            TypeManager.Activate("Android.Support.V4.View.MenuItemCompat+IOnActionExpandListenerImplementor, Xamarin.Android.Support.Compat, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new Object[0]);
        }
    }
