...
public class ViewPager_OnPageChangeListenerImplementor implements IGCUserPeer, OnPageChangeListener {
    ...
    static {
        Runtime.register("Android.Support.V4.View.ViewPager+IOnPageChangeListenerImplementor, Xamarin.Android.Support.Core.UI, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ViewPager_OnPageChangeListenerImplementor.class, __md_methods);
    }

    public ViewPager_OnPageChangeListenerImplementor() {
        if (getClass() == ViewPager_OnPageChangeListenerImplementor.class) {
            TypeManager.Activate("Android.Support.V4.View.ViewPager+IOnPageChangeListenerImplementor, Xamarin.Android.Support.Core.UI, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new Object[0]);
        }
    }
