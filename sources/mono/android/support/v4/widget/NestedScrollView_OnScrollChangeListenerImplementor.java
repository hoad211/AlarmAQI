...
public class NestedScrollView_OnScrollChangeListenerImplementor implements IGCUserPeer, OnScrollChangeListener {
    ...
    static {
        Runtime.register("Android.Support.V4.Widget.NestedScrollView+IOnScrollChangeListenerImplementor, Xamarin.Android.Support.Core.UI, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", NestedScrollView_OnScrollChangeListenerImplementor.class, __md_methods);
    }
    ...
    public NestedScrollView_OnScrollChangeListenerImplementor() {
        if (getClass() == NestedScrollView_OnScrollChangeListenerImplementor.class) {
            TypeManager.Activate("Android.Support.V4.Widget.NestedScrollView+IOnScrollChangeListenerImplementor, Xamarin.Android.Support.Core.UI, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new Object[0]);
        }
    }
