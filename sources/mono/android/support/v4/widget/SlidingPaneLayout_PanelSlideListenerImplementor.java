...
public class SlidingPaneLayout_PanelSlideListenerImplementor implements IGCUserPeer, PanelSlideListener {
    ...
    static {
        Runtime.register("Android.Support.V4.Widget.SlidingPaneLayout+IPanelSlideListenerImplementor, Xamarin.Android.Support.Core.UI, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", SlidingPaneLayout_PanelSlideListenerImplementor.class, __md_methods);
    }

    public SlidingPaneLayout_PanelSlideListenerImplementor() {
        if (getClass() == SlidingPaneLayout_PanelSlideListenerImplementor.class) {
            TypeManager.Activate("Android.Support.V4.Widget.SlidingPaneLayout+IPanelSlideListenerImplementor, Xamarin.Android.Support.Core.UI, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new Object[0]);
        }
    }
